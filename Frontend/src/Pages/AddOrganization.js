...
const mapStateToProps = (state) => {
  return {
    annualReportType: state.annualReportType,
...
class AddOrganization extends Component {
  ...
  componentDidMount() {
    let { annualReportType, companyInformation } = this.props;

    console.log(annualReportType, ">> ANNUAL REPORT");
    console.log(companyInformation, ">> COMPANY INFO");
  }
    ...
    return (
      <div className="parent">
        ...
        <InputText
          ...
          onChange={(e) => this.setState({ organizationNo: e.target.value })}
        />
        <br />
        <br />
        ...
        <InputText
          ...
          onChange={(e) => this.setState({ ceoName: e.target.value })}
        />
        <br />
        <br />
        <b>Phone</b>
...
export default connect(mapStateToProps, null)(AddOrganization);
